...
public class WeightedBootstrapping {
    ...
    public WeightedBootstrapping(double[][] allStudents2) {
        this.fileName = "C:\\Users\\marco\\Documents\\Project 1-1\\CODE\\STEP3 2\\Step3\\CurrentGrades.csv";
        this.numRows = 1329;
        this.numCols = 33;
        this.course = course ; 
        this.allStudents = allStudents2 ; 


    }

    public double[][] getWeightedBootrsapp() throws FileNotFoundException {
        

        double[][] allCoursesCount = new double[33][11];

        double[][] grades = new double[allStudents.length][allStudents[0].length];
