...
//            String[] Cate2  = categroy2class(allStudents, InfoArr, Num, Category2, 2);
...
//
//
//    public static double average(double [][] allStudents , int course ) {
//        double sum = 0;
//
//        for( int i = 0 ; i <allStudents.length ; i++ ){
...
//
//    }
//    public static double average2(double [] allStudents , int course ) {
//        double sum = 0;
//
//        for( int i = 0 ; i <allStudents.length ; i++ ){
//            sum += allStudents[i];
...
//
//    }
//    public static double TotalVariance2 ( double[] allStudents , int course){
//        double TotalVar= 0 ;
//        double sum = 0 ;
//        double average1Z = average2(allStudents, course);
//
//        for( int i = 0 ; i <allStudents.length ; i++ ){
...
//        double TotalVar= 0 ;
//        double sum = 0 ;
//        double average1Z = average(allStudents, course);
//
//        for( int i = 0 ; i <allStudents.length ; i++ ){
...
//        return TotalVar;
//    }
//    public static double calculateWeightedVariance(double[][] allStudents,String[] Categroy, int course, int Catnum ) {// change the parameter to the subCatergory A or whatever to make it specific for what you want.
//            int[] Counter = new int[Categroy.length];
//
//            // Count the occurrences of each grade
//            for (int i = 0; i < infoInStrings.length; i++) {
//                for ( int j =0 ; j<Categroy.length ; j++){
//                    if(infoInStrings[i][Catnum].equals(Categroy[j])){
//                        Counter[j]++;
//                    }
//                }
//
...
//            double []weight = new double[Counter.length ];
//            double sumWeights = 0;
//
//            for( int i = 0 ; i<Counter.length ; i++){
//                weight[i] = Counter[i]/allStudents.length ;
//            }
//
//        // Total variance but specific to category[i]
//        double[] CatgeroyListSpec = new double[Counter.length];
//        for (int i = 0; i < CatgeroyListSpec.length; i++) {
//
//        }
//
//        for ( int i = 0 ; i<Categroy.length; i++){
//            for( int j = 0 ; j<)
//            if (Categroy[i].equals(infoInStrings[i][Catnum])){
//                CatgeroyListSpec[]
//
//            }
//            double VarWeight = TotalVariance2(CatgeroyListSpec, course);
//
//
//        }
//
